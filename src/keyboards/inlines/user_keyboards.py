...
from keyboards.inlines.callback_data import navigation_products_callback, basket_callback, \
    product_count_callback, questions_callback
...
questions_keyboards = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text='Анкетирование',
                                 callback_data=questions_callback.new(
                                     action='question'
                                 ))
        ]
    ])